              ...
              <div class="col-md-9">
                <table class="table table-sm table-vcenter table-bordered">
                  ...
                  <tr>
                    ...
                    <td><a href="#" data-toggle="modal" data-target="#modal-compose<?php echo $row2['afml_detail_id'] ?>">edit</a>
                    <!-- Compose Modal -->
                            ...
                            <div class="block block-themed block-transparent mb-0">
                              <div class="block-header">
                                <h3 class="block-title">
                                  <i class="fa fa-pencil mr-5"></i> Edit Hour Data
                                </h3>
                              ...
                              <div class="block-content">
                                <form method="POST" action="afml-change-hour-edit.php" enctype="multipart/form-data">
                                  <input type="hidden" name="afml_id" value="<?php echo $row['afml_id'] ?>">
                                  ...
                                  <input type="hidden" name="brought_fwd_ac_hrs_old" value="<?php echo $row['brought_fwd_ac_hrs'] ?>">
                                  <input type="hidden" name="brought_fwd_ac_ldg_old" value="<?php echo $row['brought_fwd_ac_ldg'] ?>">
                                  <input type="hidden" name="brought_fwd_eng_1_hrs_old" value="<?php echo $row['brought_fwd_eng_1_hrs'] ?>">
                                  <input type="hidden" name="brought_fwd_eng_1_ldg_old" value="<?php echo $row['brought_fwd_eng_1_ldg'] ?>">
                                  <input type="hidden" name="brought_fwd_prop_hrs_old" value="<?php echo $row['brought_fwd_prop_hrs'] ?>">

                                  <input type="hidden" name="afml_route_from_old" value="<?php echo $row['afml_route_from'] ?>">
                                  <input type="hidden" name="afml_route_to_old" value="<?php echo $row['afml_route_to'] ?>">
                                  <input type="hidden" name="afml_block_off_old" value="<?php echo minutesToHours($row['afml_block_off']) ?>">
                                  <input type="hidden" name="afml_block_on_old" value="<?php echo minutesToHours($row['afml_block_on']) ?>">
                                  <input type="hidden" name="afml_to_old" value="<?php echo minutesToHours($row['afml_to']) ?>">
                                  <input type="hidden" name="afml_ldg_old" value="<?php echo minutesToHours($row['afml_ldg']) ?>">
                                  <input type="hidden" name="afml_ldg_cycle_old" value="<?php echo $row['afml_ldg_cycle'] ?>">
                                  <input type="hidden" name="afml_fuel_rem_old" value="<?php echo $row['afml_fuel_rem'] ?>">
                                  <input type="hidden" name="afml_fuel_uplift_old" value="<?php echo $row['afml_fuel_uplift'] ?>">
                                  <input type="hidden" name="afml_fuel_total_old" value="<?php echo $row['afml_fuel_total'] ?>">
                                  <input type="hidden" name="afml_added_oil_old" value="<?php echo $row['afml_added_oil'] ?>">
                                  <input type="hidden" name="afml_receipt_no_old" value="<?php echo $row['afml_receipt_no'] ?>">
                                  <input type="hidden" name="afml_fuel_date_old" value="<?php echo $row['afml_fuel_date'] ?>">
                                  ...
                                  <div class="form-group row">
                                    <div class="col-6">
                                      ...
                                      <select required name="afml_route_from">
                                        ...
                                        $h1    = mysqli_query($conn,$sql1);
                                        while($row1 = mysqli_fetch_assoc($h1)) {
                                          if($row2['afml_route_from'] == $row1['iata_code']) {
                                        ?>
                                        <option selected="selected" value="<?php echo $row1['iata_code'] ?>"><?php echo $row1['iata_code'].' / '.$row1['icao_code'] ?></option>
                                        <?php }else{ ?>
                                    ...
                                    <div class="col-6">
                                      ...
                                      <select required name="afml_route_to">
                                        ...
                                        $h1    = mysqli_query($conn,$sql1);
                                        while($row1 = mysqli_fetch_assoc($h1)) {
                                          if($row2['afml_route_to'] == $row1['iata_code']) {
                                        ?>
                                        <option selected="selected" value="<?php echo $row1['iata_code'] ?>"><?php echo $row1['iata_code'].' / '.$row1['icao_code'] ?></option>
                                        <?php }else{ ?>
                                        <option value="<?php echo $row1['iata_code'] ?>"><?php echo $row1['iata_code'].' / '.$row1['icao_code'] ?></option>                               
                                  ...
                                  <div class="form-group row">
                                    <div class="col-6">
                                      <label class="col-12">Block Off</label>
                                      <input type="text" name="afml_block_off" id="afml_block_off" value="<?php echo minutesToHours($row2['afml_block_off']) ?>" />
                                    </div>
                                    <div class="col-6">
                                      <label class="col-12">Block On</label>                 
                                      <input type="text" name="afml_block_on" id="afml_block_on" value="<?php echo minutesToHours($row2['afml_block_on']) ?>" />
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    <div class="col-6">
                                      <label class="col-12">T/O</label>
                                      <input type="text" name="afml_to" id="afml_to" value="<?php echo minutesToHours($row2['afml_to']) ?>" />
                                    </div>
                                    <div class="col-6">
                                      <label class="col-12">LDG</label>
                                      <input type="text" name="afml_ldg" id="afml_ldg" value="<?php echo minutesToHours($row2['afml_ldg']) ?>" />
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    <div class="col-6">
                                      <label class="col-12">LDG Cycle</label>
                                    ...
                                    <div class="col-6">
                                      <label class="col-12">REM</label>
                                      <input type="text" name="afml_fuel_rem" value="<?php echo $row2['afml_fuel_rem'] ?>" />
                                    </div>
                                  </div>
                                  <div class="form-group row">
                                    <div class="col-6">
                                      <label class="col-12">Uplift</label>
                                      <input type="text" name="afml_fuel_uplift" value="<?php echo $row2['afml_fuel_uplift'] ?>" />
                                    </div>
                                    <div class="col-6">
                                      <label class="col-12">Total</label>
                                      <input type="text" name="afml_fuel_total" value="<?php echo $row2['afml_fuel_total'] ?>" />
                                    </div>
                                  </div>                                  
                                  <div class="form-group row">
                                    <div class="col-6">
                                      <label for="message-subject">ADDED OIL</label>
                                      <input type="text" class="form-control" name="afml_added_oil" value="<?php echo $row2['afml_added_oil'] ?>" />
                                    </div>
                                    <div class="col-6">
                                      <label for="message-subject">ADDED HYD</label>
                                      <input type="text" class="form-control" name="afml_added_hyd" value="<?php echo $row2['afml_added_hyd'] ?>" />
                                    </div>                                  
                                  </div>
                                  <br/>
                                  <div class="form-group row">
                                    <div class="col-6">
                                      ...
                                      <input type="text" class="form-control"  name="afml_receipt_no" value="<?php echo $row2['afml_receipt_no'] ?>" />
                                    </div>
                                    <div class="col-6">
                                      <label class="col-12">Date(dd/mm/yyyy)</label>
                                      <input type="text" class="form-control"  name="afml_fuel_date" id="afml_fuel_date" value="<?php echo $row2['afml_fuel_date'] ?>" />
                                    </div>          
                                  </div>                            
                                  <br/>
                                  <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                      <div class="form-material form-material-primary input-group">
                                        <select name="afml_source" style="padding-left: 5px; padding-right: 5px">
                                          <option value=""> -- Choose -- </option>
                                    ...
                                    <div class="col-4">
                                      <div class="form-material form-material-primary input-group">
                                        <select name="afml_fuel_location" style="padding-left: 5px; padding-right: 5px">
                                          <option value=""> -- Choose -- </option>
