...
//apakah ada duplikat?
$sql  = "SELECT parts_rack_location_name FROM tbl_parts_rack_location WHERE parts_rack_location_name = '".$parts_rack_location_name."' AND client_id = '".$_SESSION['client_id']."' LIMIT 1";
...
$sql   = "INSERT INTO tbl_parts_rack_location (parts_rack_location_name,parts_warehouse_id,created_date,user_id,client_id) VALUES ('".$parts_rack_location_name."','".$parts_warehouse_id."', UTC_TIMESTAMP(),'".$_SESSION['user_id']."','".$_SESSION['client_id']."')";
