        ...
        <div class="content-side">
            ...
            <div class="block pull-r-l">
                <div class="block-content">
                    <form action="report-pilot-hours-detail.php" method="GET">
                        ...
                        <div class="form-group mb-15">
                            ...
                            <div class="form-material">
                                <select class="form-control" required name="user_id">
                                    ...
                                    <?php
                                    $sql1  = "SELECT user_id,full_name FROM tbl_user WHERE department_id = 4 AND user_position LIKE '%pilot' AND client_id = '".$_SESSION['client_id']."' ORDER BY full_name";
            ...
            <div class="col-xl-12">
                <div class="block-header bg-gd-lake">
                    <h3 class="block-title">Detail Flight Data For Crew: <b><?php echo $row['full_name'] ?></b> <!--with period <b><?php echo $ket ?></b>--></h3>
                        <a href="report-pilot-hours.php">Back to Pilot Hours</a>
                    ...
                    <div class="block-content">
                        <table class="table table-sm table-vcenter">
                            ...
                            while($row = mysqli_fetch_assoc($h)) {
                                ...
                                $sql_price_pilot  = "SELECT sum(total_price_pilot) as total_price_pilot FROM tbl_afml_detail a INNER JOIN tbl_afml b USING (afml_page_no) WHERE b.afml_captain_user_id = '".$user_id."' AND $range_tgl AND afml_detail_id = '".$row['afml_detail_id']."'";
                                $h_price_pilot    = mysqli_query($conn, $sql_price_pilot);
                                $row_price_pilot  = mysqli_fetch_assoc($h_price_pilot);

                                $sql_price_copilot  = "SELECT sum(total_price_copilot) as total_price_copilot FROM tbl_afml_detail a INNER JOIN tbl_afml b USING (afml_page_no) WHERE b.afml_copilot_user_id = '".$user_id."' AND $range_tgl AND afml_detail_id = '".$row['afml_detail_id']."'";
