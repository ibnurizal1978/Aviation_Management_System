    ...
    <!--begin list data-->
      ...
      //for total count data
        if(@$_REQUEST['s']=='1091vdf8ame151') {
            ...
            $sql = "SELECT km_content_id,km_name,date_format(created_date, '%d/%m/%Y') as created_date FROM tbl_km_content WHERE client_id = '".$_SESSION['client_id']."' ORDER BY km_name LIMIT $offset, $dataPerPage";
        }
      $rs_result = mysqli_query($conn, $sql);
      if(mysqli_num_rows($rs_result)==0) {
      ?>
        <p class="text-center text-danger" role="alert">No files at this moment :(</p>
      <?php  
      //exit(); 
      }
      ?>
            ...
            <div class="row">
                <div class="col-md-12 col-xl-12">
                    ...
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Files Center</h3>
                        <div class="block-options">
                            ...
                            <table class="table table-borderless table-vcenter mb-0">
                                <tr>
                                    <td class="js-task-content font-w600">
                                        <?php echo $row['km_name'] ?>
                                    </td>
                                    <td class="text-right" style="width: 100px;">
                                        <a class="js-task-star btn btn-sm btn-alt-success" href="files-detail.php?act=29dvi59&ntf=29dvi59-<?php echo $row["km_content_id"]?>-94dfvj!sdf-349ffuaw">
                                            <i class="si si-eye"></i>
                                        </a>
                                    </td>
                                </tr>
        ...
        if(@$_REQUEST['s']=='1091vdf8ame151') {           
          ...
          $sql = "SELECT count(km_content_id) as jumData FROM tbl_km_content WHERE client_id = '".$_SESSION['client_id']."'";
        }           
