        ...
        <div class="content-side">
            ...
            <div class="block pull-r-l">
                <div class="block-content">
                    <form action="report-pilot-hours.php" method="GET">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="report-pilot-hours-detail.php?act=29dvi59&ntf=29dvi59-<?php echo $row["user_id"]?>-<?php echo $bulan ?>-94dfvj!sdf-349ffuaw">Detail</a>
                                    </td>                                    
                                </tr>
                            <?php } ?>
                            </tbody>
