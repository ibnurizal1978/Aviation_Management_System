        ...
        <div class="content-side">
            ...
            <div class="block pull-r-l">
                <div class="block-content">
                    <form action="report-eob-hours.php" method="GET">
                ...
                <div class="block block-rounded">
                    <div class="block-content">
                        <table class="table table-borderless table-striped">
                            ...
                            <tbody>
                                <?php
                                $sql  = "SELECT user_id,full_name, lic_no FROM tbl_user WHERE department_id = 1 AND user_active_status = 1 AND client_id = '".$_SESSION['client_id']."' ORDER BY full_name";
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="report-eob-hours-detail.php?act=29dvi59&ntf=29dvi59-<?php echo $row["user_id"]?>-<?php echo $bulan ?>-94dfvj!sdf-349ffuaw">Detail</a>
                                    </td>                                    
                                </tr>
                            <?php } ?>
                            </tbody>
