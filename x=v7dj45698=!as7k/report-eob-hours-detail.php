...
if (@$_REQUEST['s']=='1'){
    ...
    $range_tgl  = "month(a.afml_date) = '".$ntf[2]."'  AND year(a.afml_date) = year(NOW())";
    $user_id    = $ntf[1];
}else{
...
//get adata user
$sql    = "SELECT user_id,full_name FROM tbl_user WHERE user_id = '".$user_id."' AND client_id = '".$_SESSION['client_id']."'";
$h      = mysqli_query($conn,$sql);
$row    = mysqli_fetch_assoc($h);

//hitung total hrs untuk range tanggal yang dipilih
$sql_tot1   = "SELECT SUM(a.afml_block_hrs) AS total_block_hrs, SUM(a.afml_flt_hrs) AS total_flt_hrs FROM tbl_afml_detail a INNER JOIN tbl_afml b USING (afml_page_no) WHERE b.afml_engineer_on_board_user_id = '".$user_id."' AND $range_tgl AND a.client_id = '".$_SESSION['client_id']."'";
        ...
        <div class="content-side">
            ...
            <div class="block pull-r-l">
                <div class="block-content">
                    <form action="report-eob-hours-detail.php" method="GET">
                        ...
                        <div class="form-group mb-15">
                            ...
                            <div class="form-material">
                                <select class="form-control" required name="user_id">
                                    ...
                                    <?php
                                    $sql1  = "SELECT user_id,full_name FROM tbl_user WHERE department_id = 1 AND client_id = '".$_SESSION['client_id']."' ORDER BY full_name";
        ...
        <div class="row gutters-tiny">
            <div class="col-xl-12">
                <div class="block-header bg-gd-lake">
                    <h3 class="block-title">Detail Flight Data For EOB: <b><?php echo $row['full_name'] ?></b><!-- with period <b><?php echo $ket ?></b>--></h3>
                        <a href="report-eob-hours.php">Back to EOB Hours</a>
                ...
                <div class="block block-rounded">
                    <div class="block-content">
                        <table class="table table-sm table-vcenter">
                            ...
                            <tbody>
                            <?php  
                            $sql    = "SELECT afml_detail_id, afml_id,afml_page_no,b.aircraft_reg_code, afml_block_hrs, afml_flt_hrs, date_format(a.afml_date, '%d/%m/%Y') as afml_date, total_price_eob FROM tbl_afml_detail a INNER JOIN tbl_afml b USING (afml_page_no) WHERE b.afml_engineer_on_board_user_id = '".$user_id."' AND $range_tgl AND a.client_id = '".$_SESSION['client_id']."'";       
                            $h      = mysqli_query($conn, $sql);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-black"><?php echo number_format($row['total_price_eob'],2,",",".") ?></span>
                                    </td>                                    
                                </tr>
                            <?php } ?>
