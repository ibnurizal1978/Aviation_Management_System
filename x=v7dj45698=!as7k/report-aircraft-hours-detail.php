...
if (@$_REQUEST['s']=='1'){
    ...
    $range_tgl  = "month(a.afml_date) = '".$ntf[3]."'  AND year(a.afml_date) = year(NOW())";
    $user_id    = $ntf[1].'-'.$ntf[2];
}else{
...
//get adata user
$sql    = "SELECT aircraft_reg_code FROM tbl_aircraft_master WHERE aircraft_reg_code = '".$user_id."' AND client_id = '".$_SESSION['client_id']."'";
$h      = mysqli_query($conn,$sql);
$row    = mysqli_fetch_assoc($h);

//hitung total hrs untuk range tanggal yang dipilih - sebagai captain
$sql_tot1   = "SELECT SUM(a.afml_block_hrs) AS total_block_hrs, SUM(a.afml_flt_hrs) AS total_flt_hrs FROM tbl_afml_detail a INNER JOIN tbl_afml b USING (afml_page_no) WHERE (b.aircraft_reg_code = '".$user_id."') AND $range_tgl AND a.client_id = '".$_SESSION['client_id']."'";
...
$s1 = "SELECT SEC_TO_TIME(afml_to*60) as afml_to, SUBSTRING(SEC_TO_TIME(afml_to*60),1,2) as jam, count(SUBSTRING(SEC_TO_TIME(afml_to*60),1,2)) as jumlah FROM tbl_afml_detail a INNER JOIN tbl_afml b USING (afml_page_no) WHERE (b.aircraft_reg_code = '".$user_id."') AND $range_tgl AND a.client_id = '1' GROUP BY jam order by jam";
...
$s2 = "SELECT SEC_TO_TIME(afml_flt_hrs*60) as afml_flt_hrs, SUBSTRING(SEC_TO_TIME(afml_flt_hrs*60),1,2) as jam, count(SUBSTRING(SEC_TO_TIME(afml_flt_hrs*60),1,2)) as jumlah  FROM tbl_afml_detail a INNER JOIN tbl_afml b USING (afml_page_no) WHERE (b.aircraft_reg_code = '".$user_id."') AND $range_tgl AND a.client_id = '1' GROUP BY jam order by jam";
        ...
        <div class="content-side">
            ...
            <div class="block pull-r-l">
                <div class="block-content">
                    <form action="report-aircraft-hours-detail.php" method="GET">
                        ...
                        <div class="form-group mb-15">
                            ...
                            <div class="form-material">
                                <select class="form-control" required name="user_id">
                                    ...
                                    <?php
                                    $sql1  = "SELECT aircraft_reg_code FROM tbl_aircraft_master WHERE client_id = '".$_SESSION['client_id']."' ORDER BY aircraft_reg_code";
        ...
        <div class="row gutters-tiny">
            <div class="col-xl-12">
                <div class="block-header bg-gd-lake">
                    <h3 class="block-title">Detail Flight Data For Aircraft: <b><?php echo $row['aircraft_reg_code'] ?></b> <!--with period <b><?php echo $ket ?></b>--></h3>
                        <a href="report-aircraft-hours.php">Back to Aircraft Hours</a>
                ...
                <div class="block block-rounded">
                    <div class="block-content">
                        <table class="table table-sm table-vcenter">
                            ...
                            <tbody>
                            <?php  
                            $sql    = "SELECT afml_detail_id, afml_id,afml_page_no,b.aircraft_reg_code, afml_block_hrs, afml_flt_hrs, date_format(a.afml_date, '%d/%m/%Y') as afml_date FROM tbl_afml_detail a INNER JOIN tbl_afml b USING (afml_page_no) WHERE (b.aircraft_reg_code = '".$user_id."') AND $range_tgl AND a.client_id = '".$_SESSION['client_id']."'";                   
                            $h      = mysqli_query($conn, $sql);
