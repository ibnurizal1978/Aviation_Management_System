...
<main id="main-container">
    ...
    <?php
      ...
      if(@$_REQUEST['s']=='1091vdf8ame151') {
        ...
        $sql = "SELECT * FROM tbl_parts_request a INNER JOIN tbl_user b ON a.request_user_id = b.user_id INNER JOIN tbl_parts c ON a.parts_id = c.parts_id WHERE a.request_user_id = '".$_SESSION['user_id']."' ORDER BY request_date DESC LIMIT $offset, $dataPerPage";
      }
    ...
    <?php } ?>    
        <div class="block table-responsive">
            <div class="block-header block-header-default">
                <h3 class="block-title">Parts Request Status</h3>
                <div class="block-options">
                ...
                <table class="table table-sm table-vcenter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <?php 
                              $sql2 = "SELECT full_name FROM tbl_user a INNER JOIN tbl_parts_request b ON a.user_id = b.approved_user_id WHERE b.approved_user_id = '".$row['approved_user_id']."' LIMIT 1";
                            ...
                            <td class="text-center">
                              <div class="btn-group">
                                <a data-toggle="modal" data-target="#edit-<?php echo $row['parts_id'] ?>" class="btn btn-sm btn-secondary">approved</a>
                              </div>
                            </td>
                            <!-- .modal -->                     
                                      ...
                                      <div class="box">
                                        <div class="box-body">
                                          <div class="form-group">
                                            <label>Taken From Which Warehouse?</label>
