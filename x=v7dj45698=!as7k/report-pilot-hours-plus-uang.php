                        ...
                        <table class="table table-borderless table-striped">
                            ...
                            <tbody>
                                ...
                                while($row = mysqli_fetch_assoc($h)) {
                                    ...
                                    $sql_price  = "SELECT sum(total_price) as total_price FROM tbl_afml_price WHERE user_id = '".$row['user_id']."' AND month(afml_date) = '".$bulan."'  AND year(afml_date) = year(NOW())";
                                    $h_price    = mysqli_query($conn, $sql_price);
                                    $row_price  = mysqli_fetch_assoc($h_price);                                    
                                ?>                                
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <span class="text-black"><?php echo number_format($row_price['total_price'],2,",",".") ?></span>
                                    </td>
