...
$sql  = "SELECT afml_captain as pilot, afml_copilot as copilot, afml_engineer_on_board as eob, afml_page_no,aircraft_reg_code,aircraft_serial_number,afml_type,date_format(afml_date, '%d/%m/%Y') as afml_date,afml_date as afml_date2,date_format(afml_time_preflight, '%H:%i') as afml_time_preflight,date_format(afml_time_daily, '%H:%i') as afml_time_daily,afml_station_preflight,afml_station_daily,afml_lic_preflight,afml_lic_daily, afml_captain,afml_copilot,afml_engineer_on_board,afml_pilot_sign as user_signature,
...
total_ac_hrs,total_ac_ldg,total_eng_1_hrs,total_eng_1_ldg,total_prop_hrs, afml_captain_user_id, afml_copilot_user_id
FROM tbl_afml WHERE afml_id = '".$ntf[1]."' LIMIT 1";
      ...
      <div class="block-content">
        <div class="card-body">
         <form id="form_simpan">
          ...
          <input type="hidden" name="afml_captain_user_id" value="<?php echo $row['afml_captain_user_id'] ?>"> 
          <input type="hidden" name="afml_copilot_user_id" value="<?php echo $row['afml_copilot_user_id'] ?>"> 
              ...
              <div class="col-md-3">
                ...
                <table class="table table-sm table-vcenter table-bordered">
                  <tbody>                
                    ...
                    <tr>
                      <td colspan="3"><b>CAPT:</b> <?php echo $row['pilot'] ?></td>
                    </tr>
                    <tr>
                      <td colspan="3"><b>COPIL:</b> <?php echo $row['copilot'] ?></td>
                    </tr>
                    <tr>
                      <td colspan="3"><b>ENG:</b> <?php echo $row['eob'] ?></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                      <td><b>PREFLIGHT</b></td>
