...
$target_dir2 = "../uploads/tools-certificate/";
...
$sql_d2    = "SELECT tools_file FROM tbl_tools WHERE tools_id = '".$tools_id."' AND client_id = '".$_SESSION['client_id']."' LIMIT 1";
$h_d2      = mysqli_query($conn,$sql_d2);
$row_d2    = mysqli_fetch_assoc($h_d2);
@unlink($target_dir2.$row_d2['tools_file']);
/*--------------------- end file photo ---------------------*/

$sql2   = "UPDATE tbl_tools SET tools_file='".$newfilename2."' WHERE client_id = '".$_SESSION['client_id']."' AND tools_id = '".$tools_id."' LIMIT 1";
mysqli_query($conn,$sql2);

//insert ke table log user
$sql_log   = "INSERT INTO tbl_user_log (user_log_action,user_log_module,user_id,user_log_date,user_log_notes,client_id) VALUES ('TOOLS-CERTIFICATE','TOOLS','".$_SESSION['user_id']."',UTC_TIMESTAMP(),'Add certificate for tools ID: $tools_id','".$_SESSION['client_id']."')";
