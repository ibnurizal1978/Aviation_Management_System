...
$sql   = "INSERT INTO tbl_afml_detail (afml_page_no,afml_date,aircraft_reg_code,afml_route_from,afml_route_to,afml_icao_from,afml_icao_to,afml_block_on,afml_block_off,afml_block_hrs,afml_to,afml_ldg,afml_flt_hrs,afml_ldg_cycle,created_date,user_id,client_id,trx_id) VALUES ('".$afml_page_no."','".$afml_date."','".$aircraft_reg_code."','".$afml_route_from."','".$afml_route_to."','".$row_from['icao_code']."','".$row_to['icao_code']."','".$afml_block_on."','".$afml_block_off."','".$afml_block_hrs."','".$afml_to."','".$afml_ldg."','".$afml_flt_hrs."','".$afml_ldg_cycle."', UTC_TIMESTAMP(),'".$_SESSION['user_id']."','".$_SESSION['client_id']."','".$trx_id."')";
//echo $sql;
mysqli_query($conn,$sql);

/* insert ke tbl pilot hours buat jam terbang PILOT */
$sql_hrs1 = "INSERT INTO tbl_afml_pilot_hours (afml_page_no,user_id,afml_block_on,afml_block_off,afml_block_hrs,afml_to,afml_ldg,afml_flt_hrs,afml_ldg_cycle,created_date,client_id) VALUES ('".$afml_page_no."','".$afml_captain_user_id."','".$afml_block_on."', '".$afml_block_off."', '".$afml_block_hrs."', '".$afml_to."', '".$afml_ldg."', '".$afml_flt_hrs."' ,'".$afml_ldg_cycle."', UTC_TIMESTAMP(), '".$_SESSION['client_id']."')";

//echo $sql_hrs1;
/* insert ke tbl pilot hours buat jam terbang COPILOT */
$sql_hrs2 = "INSERT INTO tbl_afml_pilot_hours (afml_page_no,user_id,afml_block_on,afml_block_off,afml_block_hrs,afml_to,afml_ldg,afml_flt_hrs,afml_ldg_cycle,client_id) VALUES ('".$afml_page_no."','".$afml_copilot_user_id."','".$afml_block_on."', '".$afml_block_off."', '".$afml_block_hrs."', '".$afml_to."', '".$afml_ldg."', '".$afml_flt_hrs."' ,'".$afml_ldg_cycle."', '".$_SESSION['client_id']."')";
